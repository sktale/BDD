#When implementation changes then scenario should not changed step defination may change
  # in below we intercting with UI the bussiness is not interested in UI interactions
  @dummyFeature
  Feature: Add to cart
